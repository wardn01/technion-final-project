...
{
    /// <summary>
    /// Character movement, jumping, rolling, gliding, swimming, fall damage, and animation sync for the player.
    /// </summary>
    ...
    public class PlayerMovement : MonoBehaviour
    {
        ...
        [Tooltip("Visual mesh root — glide tilt applies here so map icon / camera target stay upright.")]
        ...
        void Start()
        {
            ...
            if (visualsRoot == null)
            {
                ...
                if (visuals != null) visualsRoot = visuals;
            }
        ...
        /// <summary>Clears vertical and horizontal velocity — used when teleporting or loading.</summary>
        ...
        /// <summary>Resets fall tracking so the next landing does not apply carry-over fall damage.</summary>
