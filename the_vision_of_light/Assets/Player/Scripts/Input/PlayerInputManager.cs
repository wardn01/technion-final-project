...
{
    /// <summary>
    /// Reads player movement, jump, attack, and quick-slot input via <see cref="KeybindManager"/> or Unity defaults.
    /// Not Unity's Input System <c>UnityEngine.InputSystem.PlayerInput</c> / <c>PlayerInputManager</c>.
    /// </summary>
    [DisallowMultipleComponent]
    [AddComponentMenu("Vision Of Light/Player Control Input")]
    public class PlayerInputManager : MonoBehaviour
    {
        ...
        #region Quick Slots
        /// <summary>Routes hotbar key presses to <see cref="QuickSlotManager"/>.</summary>
